...
{
    // ── Brand / accent ──────────────────────────────────────────────────────────
    internal static readonly Color Accent = Color.FromArgb(255, 0x00, 0x78, 0xD7);  // Windows blue
    ...
    // ── Card backgrounds (semi-transparent fills) ───────────────────────────────
    internal static readonly SolidColorBrush CardActiveBrush   = new(Color.FromArgb(20, 0x00, 0x78, 0xD7));
    internal static readonly SolidColorBrush CardInactiveBrush = new(Color.FromArgb(12, 0x80, 0x80, 0x80));
    ...
    internal static readonly SolidColorBrush AccentBrush    = new(Accent);
}
